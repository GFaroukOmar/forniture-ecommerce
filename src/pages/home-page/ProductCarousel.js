...
//fetch api get data
const products=[
    {category:'living room',stockQuantity:10,productId:1,name:'Closet',isNew:true,discount:50,rating:5,originalPrice:400,priceAfterDiscount:200,color:'black',mainImage:'/images/products/closet.jpg',isFavorite:false,images:['/images/products/tray-table/tray-table-1','/images/products/tray-table/tray-table-2','/images/products/tray-table/tray-table-3','/images/products/tray-table/tray-table-4']},
...
const ProductCarousel = ({title}) =>{
    ...
    const productCards=products.map(p=><div className={'mb-3'}>
        <ProductCard
            product={p}
            category={p.category}
        ></ProductCard>
  ...
  return(
      <div style={{marginTop:'48px'}} className={'container'}>
          <div className={'d-flex justify-content-between'}>
              <Heading className={'LittleBald'}  level={4} c>{title}</Heading>
